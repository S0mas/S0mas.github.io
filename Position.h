...
class Board {
	inline static std::array<const char, 8> allColumns = { 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H' };
	inline static std::array<const char, 8> allRows = { '1', '2', '3', '4', '5', '6', '7', '8' };
	inline static std::array<const Position, Position::columnsNo*Position::rowsNo> allPossiblePositions = {
